...
if(isset($_POST['submit'])){
  ...
  $sql = "INSERT INTO psbooking(psname,time,payment,email,date) Values('$psname','$time','$payment','$email','$date')";
    ...
    <div class="container px-5 py-24 mx-auto ">
      ...
      <div class="lg:w-1/2 md:w-2/3 mx-auto">
        <div class="flex flex-wrap -m-2">
          ...
          <div class="p-2 w-1/2">
            <div class="relative">
              <label for="psname" class="leading-7 text-sm text-gray-600">CHoose your PS</label> <br> 
              <select name="psname" id="" required>
                
                <option value="" class="border border-indigo-100" required>Select Option!!</option>
              ...
              <div class="relative">
                ...
                <div class="relative">
                      ...
                      <input type="radio" name="time"  value="10:00 - 11:00" id="" required> 10:00 - 11:00   <br>
              ...
              <div class="p-2 w-1/2">
            <div class="relative">
              <label for="Date" class="leading-7 text-sm text-gray-600">Date</label> <br> 
